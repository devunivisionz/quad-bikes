<x-admin.master-layout>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 d-flex align-items-center">
            ...
            <button type="button" id="export_data" class="btn btn-secondary mb-2" onclick="exportData();">Export Data</button>
            </div>
        </div>
        <div class="col-12">
            <div class="card">
...
function exportData(){
    ...
    let fp = XLSX.utils.table_to_book(data,{sheet:'datasheet'})
    XLSX.write(fp,{
        bookType : 'xlsx',
        type : 'base64'
    })
