    ...
    <div class="modal-body">
        <div class="row">
            ...
            <table class="table mb-0">
                ...
                <tr>
                    <td>{{$bookingDetails->tour_name}}x{{$bookingDetails->tour_qty}}</td>
                    <td>{{$bookingDetails->date_of_tour}}</td>
                    <td>{{$bookingDetails->pickup_time}}</td>
                    <td>{{$bookingDetails->no_of_travelers}}</td>
                    <td>{{$bookingDetails->sub_total}}</td>
                </tr>
                @endforeach
                </tbody>
            </table>
